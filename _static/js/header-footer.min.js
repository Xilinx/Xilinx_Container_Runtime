...
a.element.on("click","button",function(c){console.log("click button")
});
a.element.on("click",".dropdown-menu",function(c){c.stopPropagation()
});
a.element.on("hide.bs.dropdown",function(){console.log("hide");
a._preserveState()
});
a.element.on("show.bs.dropdown",function(){console.log("show")
});
...
},_insertButton:function(b){console.log("inserting button");
var a=this;
a.element.append(b)
...
c.data("active",true);
var a=0;
c.find(".dropdown").find("> .row .container, > .row .container-fluid, > .aem-GridColumn > .container-fluid").each(function(){a+=$(this).outerHeight()
});
c.find(".dropdown").css("height",a)
},reset:function(){var b=this;
function a(){var c=0;
b.element.find(".dropdown").find("> .row .container, > .row .container-fluid, > .aem-GridColumn > .container-fluid").each(function(){c+=$(this).outerHeight()
});
...
var c=$(this).text();
if(b){if((b.match(/^https?\:/i))&&(b.indexOf("/login/signout")===-1)&&(!b.match(document.domain))){$(this).attr("target","_blank")
...
a.dropdownSelect.html(f+'<span class="far fa-angle-down"></span>');
a.updatePadding()
